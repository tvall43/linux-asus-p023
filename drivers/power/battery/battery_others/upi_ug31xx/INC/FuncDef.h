...
EXTERN GVOID  ADC1QueueSet(GVOID);
...
EXTERN GWORD SbsCurMeas(GVOID);                       ///< 0xC5, Dump current measurement data
EXTERN GWORD SbsPreMeas(GVOID);                       ///< 0xC6, Dump previous measurement data
