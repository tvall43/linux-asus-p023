...
static const GBYTE Adc1QueueInitVal[ADC1_QUEUE_SIZE] = 
{
  ...
  (     SET_M_IT |      SET_N_IT |      SET_O_IT |      SET_P_IT)    ///< 4th Conversion
};
...
GWORD ADCCalibrateETCode(GWORD wETcode)
{
  ...
  ///-------------------------------------------------------------------///
  sCodeCurr = GADC->adcCaliCode.sCodeCurr;
