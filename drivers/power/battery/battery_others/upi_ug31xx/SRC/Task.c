...
{   
  ...
  GLOGE("OVERALL-%02d:%02d:%02d(%dms)>dT:%d,V:%d,I:%d,IT:%d,ET:%d,R:%d(%d/%d),Q:%lld(%d),RID:%d.%d,S:%04x-%04x-%04x-%04x(%d) DV:%s, ID:%s-%s, GV:%04x\n",
        ...
        UpiGauge.wSysMode, UpiGauge.wGaugeStatus, UpiGauge.wErrorStatus, UpiGauge.wWarningStatus, UpiGauge.loopIdx,
