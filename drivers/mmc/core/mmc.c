...
#if 0
    card->ext_csd.raw_card_type &= ~(EXT_CSD_CARD_TYPE_DDR_1_8V |
...
MMC_DEV_ATTR(fwrev_atd, "0x%x\n", (card->raw_cid[2] >> 16) & 0xff);
MMC_DEV_ATTR(sectors_atd, "0x%x\n", card->ext_csd.sectors);
MMC_DEV_ATTR(emmc_total_size, "%d\n", (card->ext_csd.sectors >> (fls(card->ext_csd.sectors) - 1)) << (fls(card->ext_csd.sectors) - 21));
static struct attribute *mmc_std_attrs[] = {
	...
	&dev_attr_fwrev_atd.attr,
	&dev_attr_sectors_atd.attr,
