...
void bmm050_screen_chenged_listaner(const int state);
#endif
...
*/
	...
	// reg callback
#ifdef CONFIG_PM_SCREEN_STATE_NOTIFIER
	callback_struct = register_screen_state_notifier(&bmm050_screen_chenged_listaner);
#endif
...
/* Add by Tom for SR */
static const struct i2c_device_id bmm_id_SR[] = {
	{"ecompass_sr", 0},
	{}
};

static const struct of_device_id bmm050_of_match_SR[] = {
	{ .compatible = "bosch,bmm050_SR", },
	{ },
};

static struct i2c_driver bmm_driver_SR = {
	.driver = {
		.owner = THIS_MODULE,
		.name = SENSOR_NAME,
		.of_match_table = bmm050_of_match_SR,
	},
	.class = I2C_CLASS_HWMON,
	.id_table = bmm_id_SR,
	.probe = bmm_probe,
...
static int __init BMM_init(void)
{
	...
	if(hw_id == HW_ID_SR)
		return i2c_add_driver(&bmm_driver_SR);
	else 
