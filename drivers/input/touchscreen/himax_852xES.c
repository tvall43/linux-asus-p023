...
static u8 g_proximity_en = 0;
	...
	{
		#include "Himax_Firmware_20141218_FE71_0500_00_00.i" 
	};
#else // for intel
#include <linux/platform_data/himax_FW.h>
#endif
#endif
	...
	if(IC_TYPE == HX_85XX_ES_SERIES_PWON)
		{
			...
			HX_INT_IS_EDGE = true; // fix to edge trigger
...
static int i_update_FW(void)
{
	...
	if ( private_ts->vendor_fw_ver < i_CTPM_FW[FW_VER_MIN_FLASH_ADDR] )
		{		 
