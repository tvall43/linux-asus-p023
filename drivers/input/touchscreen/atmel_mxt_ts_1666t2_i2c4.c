...
#ifdef CONFIG_OF
static const struct of_device_id mxt_of_match_i2c4[] = {
	{ .compatible = "atmel,maxtouch_i2c4", },
	{},
};
MODULE_DEVICE_TABLE(of, mxt_of_match_i2c4);
#else
#define mxt_of_match_i2c4 NULL
#endif

static const struct i2c_device_id mxt_id_i2c4[] = {
	{ "qt602240_ts", 0 },
	{ "atmel_mxt_ts_i2c4", 0 },
	{ "atmel_mxt_tp", 0 },
	{ "mXT224", 0 },
...
MODULE_DEVICE_TABLE(i2c, mxt_id_i2c4);

static struct i2c_driver mxt_driver_i2c4 = {
	.driver = {
		.name	= "atmel_mxt_ts_i2c4",
		.owner	= THIS_MODULE,
		.of_match_table = mxt_of_match_i2c4,
		//.pm	= &mxt_pm_ops,
	},
	.probe		= mxt_probe,
	.remove		= mxt_remove,
	.id_table	= mxt_id_i2c4,
};

static int __init mxt_init(void)
{
	int HW_ID = Read_HW_ID();
	printk("[Atmel] %s ++ I2C_4 ++, HW_ID:%d \n",__func__,HW_ID);
	if(HW_ID != HW_ID_ER){
		return 0;
	}
	...
	return i2c_add_driver(&mxt_driver_i2c4);
}

static void __exit mxt_exit(void)
{
	i2c_del_driver(&mxt_driver_i2c4);
}
