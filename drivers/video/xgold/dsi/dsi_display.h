...
struct dsi_display {
	...
	struct display_gpio *gpios_lcd_reset;
	struct display_gpio *gpios_reset_low;
	...
	void (*lcd_reset)(struct dsi_display *display);
	int (*sleep_in)(struct dsi_display *display);
	int (*sleep_out)(struct dsi_display *display);
	void (*reset_low)(struct dsi_display *display);
