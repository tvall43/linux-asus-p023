...
static enum cif_isp20_colorspace cif_isp20_v4l2_cs2cif_isp20_cs(
	u32 v4l2_colorspace)
{
	if (v4l2_colorspace == V4L2_COLORSPACE_JPEG)
		return CIF_FULL_COLOR_RANGE;
	else
		return CIF_REDUCED_COLOR_RANGE;
}
	...
	struct v4l2_format *f)
{
	...
	strm_fmt.frm_fmt.colorspace =
		cif_isp20_v4l2_cs2cif_isp20_cs(
