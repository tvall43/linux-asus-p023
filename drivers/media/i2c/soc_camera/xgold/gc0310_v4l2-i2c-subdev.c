...
static unsigned int ATD_gc0310_status;
...
static const struct gc_camera_module_reg gc0310_init_tab_vga_30fps[] = {
	...
	{GC_CAMERA_MODULE_REG_TYPE_DATA, 0x02, 0x01},/* 0x11 20150414 VOD */
	...
	{GC_CAMERA_MODULE_REG_TYPE_DATA, 0x15, 0x11},/*0x12 -> 0x11 discontinuous by line*/
	...
	/*ISP reg*/
	{GC_CAMERA_MODULE_REG_TYPE_DATA, 0x40, 0x0e}, /* dn & dd */
	{GC_CAMERA_MODULE_REG_TYPE_DATA, 0x41, 0x01},
	{GC_CAMERA_MODULE_REG_TYPE_DATA, 0x42, 0x00},
	{GC_CAMERA_MODULE_REG_TYPE_DATA, 0x44, 0x17}, /* dndd out */
	{GC_CAMERA_MODULE_REG_TYPE_DATA, 0x46, 0x32},
	{GC_CAMERA_MODULE_REG_TYPE_DATA, 0x49, 0x03},
	{GC_CAMERA_MODULE_REG_TYPE_DATA, 0x4c, 0xa0}, /*test pattern 24*/
	...
	{GC_CAMERA_MODULE_REG_TYPE_DATA, 0x44, 0x03},
        ...
        /*DNDD*/
        {GC_CAMERA_MODULE_REG_TYPE_DATA, 0xfe, 0x00},
        {GC_CAMERA_MODULE_REG_TYPE_DATA, 0x82, 0x02}, //default 0x08 20150511//
        {GC_CAMERA_MODULE_REG_TYPE_DATA, 0x83, 0x10}, //20150511//
...
static int gc0310_start_streaming(struct gc_camera_module *cam_mod)
{
	...
	gc_camera_module_pr_debug(cam_mod, "\n");
        ...
        printk("[DEBUG] v3 gc0310_start_streaming");
...
static int gc0310_stop_streaming(struct gc_camera_module *cam_mod)
{
	...
	gc_camera_module_pr_debug(cam_mod, "\n");
        ...
        printk("[DEBUG] v3 gc0310_stop_streaming");
...
static int gc0310_dbgfs_init(void)
{
	...
	debugfs_create_u32("vga_status", 0644, debugfs_dir, &ATD_gc0310_status);
	...
	const struct i2c_device_id *id)
{
	...
	pcb_id = Read_PCB_ID();
	if(((pcb_id>>10) & 0x1) != 0) {
		dev_info(&client->dev, "2M SKU, bypass 0.3M probe\n");
		return -1;
	}
	#endif
	...
	gc0310_dbgfs_init(); //ASUS_BSP+++ ATD camera status
