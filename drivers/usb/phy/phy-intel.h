...
#define B_BUS_REQ	16
    ...
    bool usb_dpn_sel_gpio_active_low; /* active: in cover's view */
    int usb_cover_id_gpio;
    bool usb_cover_id_gpio_active_low;
...
#define USB_SESSION_COVER 1
    ...
    int mult_np_det_gpio;
    bool mult_np_det_gpio_active_low;
    bool ahost_force_disconnect;
    struct completion otg_complete;
};
