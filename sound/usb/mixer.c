			      ...
			      int readonly_mask)
{
	...
	if (cval->mixer->chip->usb_id == USB_ID(0x0d8c, 0x0102)) {
		...
		if (strcmp(kctl->id.name, "Speaker Playback Volume") == 0) {
			...
			//int s_volume[] = {-6096, -6096, -4656, -4656, -6096, -6096, -6096, -6096}; 
			// joe_cheng : effect on 120, 120, 100, 100, 120, 120, 120, 120
			//int s_volume[] = {-3696, -3696, -4656, -4656, -3696, -3696, -3696, -3696};
			// joe_cheng : effect on/off 196 196 150 150 196 196 196 196
			//int s_volume[] = {-48, -48, -2256, -2256, -48, -48, -48, -48};
