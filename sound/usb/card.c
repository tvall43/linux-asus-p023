...
static int SetCmediaDeltaSigmaReset(struct snd_usb_audio *chip)  // for CM-6206LX
{
                   ...
                   &dwTemp, sizeof(int))) < 0)
    {
        ...
        //snd_printk(KERN_ERR "SetCmediaDeltaSigmaReset() low success\n");
                   ...
                   &dwTemp, sizeof(int))) < 0)
    {
        ...
        //snd_printk(KERN_ERR "SetCmediaDeltaSigmaReset() high success\n");
...
int snd_usb_autoresume(struct snd_usb_audio *chip)
{
    ...
    if (chip->usb_id == USB_ID(0x0d8c, 0x0102)) {
        //snd_printk(KERN_INFO "###### cmedia ---> snd_usb_autoresume()\n");
