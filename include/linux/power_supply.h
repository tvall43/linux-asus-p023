...
enum power_supply_type {
	...
	POWER_SUPPLY_TYPE_OTG,		/* chris: add for OTG online */
};
...
enum power_supply_charger_cable_type {
	...
	POWER_SUPPLY_CHARGER_TYPE_OTG = 1 << 13,
	POWER_SUPPLY_CHARGER_TYPE_OTG_OUT = 1 << 14,
	POWER_SUPPLY_CHARGER_TYPE_OTG_ASYNC = 1 << 15,
	POWER_SUPPLY_CHARGER_TYPE_OTG_OUT_ASYNC = 1 << 16,
};
...
enum cover_status{
	...
	COVER_ENUMERATED,	/*COVER ENUMERATION FINISH*/
